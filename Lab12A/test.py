...
if __name__ == "__main__":
    ...
    if 1101 not in root.students:
        root.students[1101] = Student(1101, "Mr. Christian de Neuvillette","2")
    if 1102 not in root.students:
        root.students[1102] = Student(1102, "Mr. Zhong Li", "2")
    if 1103 not in root.students:
        root.students[1103] = Student(1103, "Mr. Dvalinn Durinson", "2")
